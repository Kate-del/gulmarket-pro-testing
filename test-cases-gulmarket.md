...
Ввести корректный номер и пароль
...
Выбрать опцию Добавить магазин

Не заполнять обязательные поля (например, название магазина, описание, адрес и т.д.)
...
Заполнить все обязательные поля (загрузить фото, название магазина, описание, адрес, контактный номер и т.д.)
...
Заполнить все обязательные поля (название букета, фото, цена)

Нажать кнопку "Создать букет"
...
Заполнить все обязательные поля (название товара, фото, цена)
...
Попробовать нажать кнопку "Состав комбо"
...
Заполнить все обязательные поля (название товара, фото товара, цена)
